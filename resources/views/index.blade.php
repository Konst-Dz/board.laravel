...
@section('content')
    <div class="site-blocks-cover overlay" style="background-image: {{asset('images/hero_2.jpg')}}" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
                ...
                <div class="col-12  block-13">
                    <div class="owl-carousel nonloop-block-13">
                        ...
                        <div class="d-block d-md-flex listing vertical">
                            <a href="listings-single.html" class="img d-block" style="background-image: {{asset('storage/img_1.jpg')}}"></a>
                        ...
                        <div class="d-block d-md-flex listing vertical">
                            <a href="listings-single.html" class="img d-block" style="background-image: {{asset('images/img_2.jpg')}}"></a>
                            <div class="lh-content">
